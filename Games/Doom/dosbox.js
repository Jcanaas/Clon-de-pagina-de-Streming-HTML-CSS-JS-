...
(function(){function B(){return+new Date}var D=function(a,b){if(a===""&&b)return b;var d=a.split(" "),c=d.shift(),e;if(c.charAt(0)=="#"){var g=i.getElementById(c.substring(1));e=g?[g]:[]}else{e=c.charAt(0)!=="."?c.split(".")[0]:"*";var h=c.split("."),j=null;if(e.indexOf("[")!=-1){j=e;e=e.substr(0,e.indexOf("["))}g=function(o){var n=arguments.callee,k;if(!(k=!n.needClass)){k=n.classes;if(o.className.length==0)k=false;else{for(var r=o.className.split(" "),l=k.length,p=0;p<k.length;p++)f.inArray(k[p],
    ...
    (function() {
      Dosbox.UI = (function() {
        ...
        UI.prototype.css = '.dosbox-container { position: relative; min-width: 320px; min-height: 200px; background-color: #141414; } \
.dosbox-canvas { } \
.dosbox-overlay, .dosbox-loader { position: absolute; left: 0; right: 0; top: 0; bottom: 0; background-color: #141414; } \
.dosbox-start { text-align: center; position: absolute; left: 0; right: 0; bottom: 50%; color: rgb(229, 8, 152); font-size: 1.5em; text-decoration: underline; cursor: pointer; animation: pump 1.7s infinite; } /* Correct pink color and pumping effect */ \
.dosbox-overlay a { color: #f80; } \
.dosbox-loader { display: none; } \
...
.st-loader:before, .st-loader:after { border: 0.25em solid #f80; } \
.st-loader .equal { border: 0.25em solid #f80; } \
@keyframes pump { \
